...
<body>
<h3> You can add another tree here to the same request or to navigate to home page click below </h3>
		...
		<form action="tree">
			<table border="1" cellpadding="5">
				...
				<tr>
					<th>Req_id: </th>
					<td align="center" colspan="3">
						<input type="text" name="req_id" size="45"  value="${req_id}" onfocus="this.value=''">
					</td>
				</tr>
				<tr>
					<th>Tree Size: </th>
