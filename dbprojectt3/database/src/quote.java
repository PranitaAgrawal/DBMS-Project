...
public class quote {
    ...
    //{
    	...
    	//this.email = email;
    //}
    public quote(int client_id, int req_id, String status,float price, String startdate, String enddate, String dnote, String note, String size, String height, String location, String distance ) 
    {
